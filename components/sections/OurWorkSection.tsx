...
return (
		<section id="our-work" className="w-full bg-[#F3F7F8] py-12 sm:py-16 lg:py-20 overflow-hidden">
			<div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20">
				...
				<div className="relative py-4 w-[100vw]">
					<Slider {...sliderSettings} className="our-work-slider">
						{projects.map((project, index) => (
							<div key={index} className="px-3 lg:px-[22px] py-4">
								<div className="w-full rounded-2xl bg-white border border-white shadow-[0_2px_21px_0_rgba(0,0,0,0.10)]">
									<div className="w-full h-[258px] rounded-t-lg bg-white p-2">
										<div className="w-full h-full rounded bg-secondary/20"></div>
									</div>
