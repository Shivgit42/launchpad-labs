...
export default function Navbar() {
	return (
		<nav className="sticky top-0 z-50 w-full bg-[#F3F7F8]/90 backdrop-blur px-4 sm:px-6 lg:px-20 py-3">
			<div className="max-w-[1440px] mx-auto">
				<div className="flex items-center justify-between rounded-[14px] border border-black/10 bg-white px-4 sm:px-6 lg:px-8 h-[64px] shadow-[0_2px_11px_rgba(0,0,0,0.06)]">
